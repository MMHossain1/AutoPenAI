        ...
        <div className="w-full max-w-[440px] space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[#616e89] dark:text-[#94a3b8]">
              Sign in to access your dashboard and active scans
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded border-[#dbdee6] dark:border-[#4a5568] text-blue-600 focus:ring-blue-600 dark:bg-[#2d3748]"
                  />
                  <label
                    htmlFor="remember-me"
                    className="ml-2 block text-sm text-[#616e89] dark:text-[#94a3b8]"
                  >
                    Stay signed in
                  </label>
                </div>
