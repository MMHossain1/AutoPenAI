...
function FeatureCard({ icon, title, description, linkText, accentColor }: FeatureCardProps) {
  ...
  return (
    <div className={`glass-card group p-8 rounded-2xl ${borderColor} transition-all duration-300`}>
...
export default function Features() {
  ...
  return (
    <section className="relative max-w-7xl mx-auto px-6 pt-10 pb-16">
      ...
      <div className="absolute -top-32 inset-x-0 h-32 bg-gradient-to-b from-background-light/0 dark:from-background-dark/0 to-transparent pointer-events-none"></div>
      <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
        <div className="max-w-2xl">
          <h4 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-slate-950 dark:text-white">Platform Capabilities</h4>
          <p className="text-muted-foreground text-lg">Automated security testing designed for modern engineering teams, integrating directly into your development workflow.</p>
        </div>
      </div>
